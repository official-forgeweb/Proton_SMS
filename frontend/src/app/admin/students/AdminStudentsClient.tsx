...
export default function AdminStudentsClient({ initialData }: Props) {
    ...
    useEffect(() => {
        ...
        if (
            ...
            selectedStatus === '' && 
            selectedFeeStatus === '' &&
            students === initialData.students // Only true on mount or very rarely
        ) {
            return;
        }
        fetchStudents();
    }, [search, selectedBatch, selectedSubject, selectedStatus, selectedFeeStatus, page]);
