...
export default function EditStudentPage() {
    ...
    return (
        <FormPageLayout
            ...
            subtitle="Update student personal profile, parent details, and enrolled batches"
            ...
            <form onSubmit={handleSubmit}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '20px', alignItems: 'start', marginBottom: '20px' }}>
                        ...
                        <SectionCard title="Parent / Guardian Details" icon={<Users size={18} />}>
                            <FormGrid columns={2}>
                                <FieldGroup label="Father's Name">
                                    <input className="form-input" value={formData.father_name} onChange={e => setFormData({ ...formData, father_name: e.target.value })} />
                                </FieldGroup>
                                <FieldGroup label="Father's Mobile Number">
                                    <input className="form-input" value={formData.father_phone} onChange={e => setFormData({ ...formData, father_phone: e.target.value })} />
                                </FieldGroup>
                                <FieldGroup label="Mother's Name">
                                    <input className="form-input" value={formData.mother_name} onChange={e => setFormData({ ...formData, mother_name: e.target.value })} />
                                </FieldGroup>
                                <FieldGroup label="Mother's Mobile Number">
                                    <input className="form-input" value={formData.mother_phone} onChange={e => setFormData({ ...formData, mother_phone: e.target.value })} />
                                </FieldGroup>
                            </FormGrid>
                        </SectionCard>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <SectionCard title="Additional Settings" icon={<Users size={18} />}>
                            <FormGrid columns={2}>
