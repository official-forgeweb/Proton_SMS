                ...
                <div style={{ width: '100%', maxWidth: '1100px', background: '#FFFFFF', borderRadius: '20px', padding: '32px', border: '1px solid #F0F0F5', boxShadow: '0 8px 24px rgba(0,0,0,0.04)' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F0F0F5', paddingBottom: '20px', marginBottom: '28px' }}>
                        <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
                            ...
                            <div>
                                <div className="skeleton" style={{ width: '180px', height: '22px', borderRadius: '8px', marginBottom: '8px' }} />
                                <div className="skeleton" style={{ width: '320px', height: '14px', borderRadius: '6px' }} />
                            </div>
                        </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', alignItems: 'start' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div style={{ background: '#FFFFFF', border: '1px solid #F0F0F5', padding: '28px', borderRadius: '16px' }}>
                                ...
                                <div style={{ marginTop: '24px' }}>
                                    <div className="skeleton" style={{ width: '70px', height: '12px', borderRadius: '6px', marginBottom: '8px' }} />
                                    <div className="skeleton" style={{ width: '100%', height: '80px', borderRadius: '10px' }} />
                                </div>
                            </div>
                        ...
                        <div>
                            <div style={{ background: '#FFFFFF', border: '1px solid #F0F0F5', padding: '28px', borderRadius: '16px' }}>
                                ...
                                <div className="skeleton" style={{ width: '100%', height: '46px', borderRadius: '10px', marginBottom: '24px' }} />
                                <div className="skeleton" style={{ width: '140px', height: '12px', borderRadius: '6px', marginBottom: '8px' }} />
                                <div className="skeleton" style={{ width: '100%', height: '46px', borderRadius: '10px' }} />
                            </div>
                        </div>
