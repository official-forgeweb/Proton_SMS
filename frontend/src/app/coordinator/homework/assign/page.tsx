...
export default function CoordinatorAssignHomeworkPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/coordinator/homework');
        } catch (error) {
        ...
        >
            <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <CustomSelect
                                ...
                                options={classes.map(c => ({
                                    value: c.id,
                                    label: c.batch_type ? `${c.class_name} • ${c.batch_type.toUpperCase()} BATCH` : c.class_name
                                }))}
                            />
                        </div>
                        <div>
                ...
                <div className="form-actions">
                    <button type="button" className="btn-cancel" onClick={() => router.push('/coordinator/homework')}>Cancel</button>
