...
export default function CoordinatorTestProfilePage() {
        ...
        return (
            <DashboardLayout requiredRole="coordinator">
                <div style={{ padding: '80px 24px', textAlign: 'center' }}>
                    ...
                    <button className="btn btn-primary" onClick={() => router.push('/coordinator/tests')} style={{ marginTop: '16px' }}>Back to Tests</button>
                </div>
            </DashboardLayout>
        );
    }
        ...
        <DashboardLayout requiredRole="coordinator">
            <div style={{ padding: '24px', maxWidth: '1600px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
                ...
                <div className="animate-fade" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                    <div>
                        <button 
                            onClick={() => router.push('/coordinator/tests')}
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        <button 
                            ...
                            onClick={() => router.push(`/coordinator/tests/${test.id}/evaluate`)}
