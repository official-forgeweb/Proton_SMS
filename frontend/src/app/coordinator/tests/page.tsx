...
export default function CoordinatorTestsPage() {
                            ...
                            return (
                                <div key={test.id} className="animate-fade-in glass-card" style={{ animationDelay: `${idx * 60}ms` }}>
                                    <div style={{ padding: '20px' }}>
                                        ...
                                        <button
                                            onClick={() => router.push(`/coordinator/tests/${test.id}`)}
                                            style={{ 
