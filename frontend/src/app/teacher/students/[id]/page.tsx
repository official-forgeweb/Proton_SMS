...
function StudentHETPerformanceTab({ studentId }: { studentId: string }) {
    ...
    return (
        <div className="animate-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
                <div className="student-stat-card" style={{ padding: '16px 20px', background: '#FAFBFF' }}>
...
export default function TeacherStudentProfilePage() {
    ...
    const tabs = [
        ...
        { id: 'het', label: 'HET Performance', icon: <Award size={16} /> },
    ...
    return (
        <DashboardLayout requiredRole="teacher">
            ...
            <div className="bg-mesh min-h-screen" style={{ padding: '0 8px 32px 8px' }}>
                ...
                {/* HET PERFORMANCE TAB */}
                {activeTab === 'het' && (
                    <StudentHETPerformanceTab studentId={params.id as string} />
                )}
