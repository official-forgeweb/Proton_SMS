...
import { ArrowLeft, CheckCircle, Save, Users, AlertCircle, Info } from 'lucide-react';
    ...
    return (
        <DashboardLayout requiredRole="teacher">
            <div className="page-header">
                <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginTop: '4px' }}>
                        {testData?.class_name} • Max Marks: {testData?.total_marks} • Passing: {testData?.passing_marks} • Time: {testData?.start_time || 'N/A'}
                    </p>
                </div>
            ...
            <div className="page-body">
                {(testData?.description || (testData?.images && testData.images.length > 0)) && (
                    <div className="card" style={{ marginBottom: '24px' }}>
                        ...
                        {testData.description && (
                            <div style={{ background: 'var(--bg-secondary)', padding: '20px', borderRadius: '12px', marginBottom: testData.images?.length > 0 ? '24px' : '0', border: '1px solid var(--border-primary)' }}>
                        ...
                        {testData.images && testData.images.length > 0 && (
                            <div>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px' }}>
                                    {testData.images.map((img: string, idx: number) => (
