...
exports.getBaseHtmlLayout = void 0;
const env_1 = require("../../../config/env");
const getBaseHtmlLayout = (contentHtml, options) => {
    const appName = env_1.env.APP_NAME;
    const logoUrl = `${env_1.env.APP_URL}/logo.png`; // Fallback image or branding asset
...
exports.getBaseHtmlLayout = getBaseHtmlLayout;
